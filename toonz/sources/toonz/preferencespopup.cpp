...
QString PreferencesPopup::getUIString(PreferencesItemId id) {
  const static QMap<PreferencesItemId, QString> uiStringTable = {
      ...
      {startupPopupEnabled, tr("Show Startup Window when Inkframe Starts")},
      {tipsPopupEnabled, tr("Show Tips Window when Inkframe Starts")},
      ...
      {shortcutCommandsWhileRenamingCellEnabled,
       tr("Enable Inkframe Commands' Shortcut Keys While Renaming Cell")},
      ...
      {latestVersionCheckEnabled,
       tr("Check for the Latest Version of Inkframe on Launch")},
...
PreferencesPopup::PreferencesPopup()
  ...
  QLabel* note = new QLabel(
      tr("* Changes will take effect the next time you run Inkframe"));
...
QGridLayout* PreferencesPopup::createImportExportLayout() {
  ...
  QGridLayout* lay = new QGridLayout();
  setupLayout(lay);
  putLabel(tr("External applications used by Inkframe.\nThese come bundled "
...
#ifdef MACOSX
  QLabel* pathLabel =
      new QLabel(tr("Select the Inkframe application that you want to import "
                    "preferences from"));
#else
  QLabel* pathLabel =
      new QLabel(tr("Select the folder of the Inkframe application that you "
